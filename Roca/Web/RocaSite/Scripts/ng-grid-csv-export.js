...
function ngGridCsvExportPluginOld (opts) {
    var self = this;
    self.grid = null;
    self.scope = null;
    self.services = null;
    ...
    self.init = function(scope, grid, services) {
        ...
        function showDs() {
            ...
            var fp = angular.element(document.querySelector('.exportLinkContainer'));
            var csvDataLinkPrevious = angular.element(document.querySelector('.exportLinkContainer .csv-data-link-span'));
            if (csvDataLinkPrevious != null) { csvDataLinkPrevious.remove(); }

            if (fp == null) {
                fp = grid.$root.find(".ngFooterPanel");
            }
            csvDataLinkPrevious = grid.$root.find('.ngFooterPanel .csv-data-link-span');
            if (csvDataLinkPrevious != null) {csvDataLinkPrevious.remove() ; }
            var csvDataLinkHtml = "<span class=\"csv-data-link-span\">";
            csvDataLinkHtml += "<br><a href=\"data:text/csv;charset=UTF-8,";
            csvDataLinkHtml += encodeURIComponent(csvData);
            csvDataLinkHtml += "\" download=\"Export.csv\">CSV Export (s&oacute;lo en Chrome)</a></br></span>";
...
function ngGridCsvExportPlugin(opts) {
    ...
    self.init = function (scope, grid, services) {
        ...
        function showDs() {
            ...
            var csvDataLinkPrevious = angular.element(document.querySelector(opts.containerPanel + ' .' + opts.linkClass));
